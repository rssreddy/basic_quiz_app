...
public class QuestionService {
    ...
    public ResponseEntity<List<Question>> getAllQuestionsByCategory(String questionCategory) {
        try {
            return new ResponseEntity<>(questionDao.findAllByCategory(questionCategory), HttpStatus.OK);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
